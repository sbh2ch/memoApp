...
import com.sonn.son.memozzang.common.TitleBitmapButton;
import com.sonn.son.memozzang.common.TitleBackgroundButton;
import com.sonn.son.memozzang.db.MemoDatabase;
...
public class MemoInsertActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        insert_textBtn.setBackgroundBitmap(R.drawable.insert_btn, R.drawable.insert_btn_click);
        insert_handwritingBtn = (TitleBitmapButton)findViewById(R.id.insert_handwritingBtn);
        insert_handwritingBtn.setBackgroundBitmap(R.drawable.insert_btn,R.drawable.insert_btn_click);
        ...
        mVideoBtn.setCompoundDrawablesWithIntrinsicBounds(null, getResources().getDrawable
                (R.drawable.icon_video_empty), null, null); /** dddddd */

        mVoiceBtn.setCompoundDrawablesWithIntrinsicBounds(null, getResources().getDrawable
                (R.drawable.icon_voice_empty), null, null);


        deleteBtn.setBackgroundBitmap(R.drawable.delete_btn, R.drawable.delete_btn_click);
        ...
        insert_textBtn.setCompoundDrawablesWithIntrinsicBounds(null, getResources().getDrawable
                (R.drawable.text_btn), null, null);
        insert_handwritingBtn.setSelected(false);
        insert_handwritingBtn.setCompoundDrawablesWithIntrinsicBounds(null, getResources().getDrawable
                (R.drawable.pencil_btn_empty), null, null);  //변경
        ...
        insert_handwritingBtn.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                if (textViewMode == 0) {
                    ...
                    insert_textBtn.setCompoundDrawablesWithIntrinsicBounds(null, getResources().getDrawable
                            (R.drawable.text_empty_btn), null, null); // 변경
                    insert_textBtn.setSelected(false);
                    insert_handwritingBtn.setCompoundDrawablesWithIntrinsicBounds(null, getResources().getDrawable
                            (R.drawable.pencil_btn), null, null);
                }
            }
        });
        ...
        if(mMemoMode.equals(BasicInfo.MODE_MODIFY) || mMemoMode.equals(BasicInfo.MODE_VIEW)) {
            ...
            insertSaveBtn.setBackgroundBitmap(R.drawable.modify_btn, R.drawable.modify_btn_click);
    ...
    public void setBottomButtons() {
        ...
        // 닫기 버튼
        insertCancelBtn.setBackgroundBitmap(R.drawable.cancel_btn1, R.drawable.cancel_btn_click);
    ...
    public void setMediaLayout() {
        ...
        mVideoBtn = (TitleBitmapButton)findViewById(R.id.insert_videoBtn);
        mVideoBtn.setBackgroundBitmap(R.drawable.insert_btn, R.drawable.insert_btn_click);

        mVoiceBtn = (TitleBitmapButton)findViewById(R.id.insert_voiceBtn);
        mVoiceBtn.setBackgroundBitmap(R.drawable.insert_btn, R.drawable.insert_btn_click);

    }

    private void setCalendar(){
        insertDateButton = (TitleBitmapButton) findViewById(R.id.insert_dateBtn);
        insertDateButton.setBackgroundBitmap(R.drawable.date_time_btn, R.drawable.date_time_btn_click);
        ...
        insertTimeButton.setBackgroundBitmap(R.drawable.date_time_btn, R.drawable.date_time_btn_click);
